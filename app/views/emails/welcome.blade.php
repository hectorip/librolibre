...
<head>
  ...
  <title>Bienvenido a Libro Libre México</title>
  <style type="text/css">
            ...
            <table cellspacing="0" cellpadding="0" width="500" class="w320">
              <tr>
                <td valign="top" style="padding:10px 0; text-align:left;" class="mobile-center">
                  <img width="250" src="http://librolibre.com.mx/img/logo.png">
                </td>
              </tr>
            </table>
          </center>
                ...
                <td>
                  <table cellspacing="0" cellpadding="0" width="100%">
                    <tr>
                      ...
                      <br>
                       Gracias por suscribirte. Juntos formemos una comunidad más abierta y compartida. 
                       <a style="color: #2BB6AC;;" href="mailto:hectorip@librolibre.com.mx">Contacta con nosotros</a> si tienes cualquier duda.
                      <br>
                      <br>
                      <strong>Libro Libre MX</strong>
                      <br>
                      <br>
                      <br>
